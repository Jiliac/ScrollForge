...
- [ ] Images: Name + super short description under image? Especially for portraits
...
- [x] Memory management. **Archivist**, compress conversation? (Or implicit restart)
...
- [ ] Criticizer Orchestrated? After world advance/faction turn
